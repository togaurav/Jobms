...
public class JsonUtil {
	...
	public static List<Map<String, Object>> getListFromJsonArray(String str) {
		try {
			if (StringUtils.isNotBlank(str)) {
				...
				log
						.warn("JacksonUtil.getListsFromJsonArray error| ErrMsg: input string is null ");
				return null;
			}
		} catch (Exception e) {
			log.error("JacksonUtil.getListsFromJsonArray error| ErrMsg: "
					+ e.getMessage(), e);
	...
	public static String getJsonStringFromList(List<Map<String, Object>> list) {
		try {
			...
			log.error("JacksonUtil.getJsonStringFromMap error| ErrMsg: "
					+ e.getMessage(), e);
			return null;
		}
	}
