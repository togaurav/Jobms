  ...
  <tr>
    ...
    <td width="794" rowspan="3" align="center" valign="top"><table width="100%" height="320" border="0" cellpadding="5" cellspacing="2">
      <tr>
        <td height="26" class="toplink"><table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#333333">
          <tr>
            ...
            <td align="center" bgcolor="#FFFFFF" class="dh_selected"><strong><div onClick="showUserSkill()" style="cursor:hand">知识技能</div></strong></td>
      ...
      <tr>
        ...
        <s:form id="userSkillForm" method="post" autocomplete="false" action="saveuserskill" namespace="/user">
        <table width="100%" border="0" cellpadding="1" cellspacing="1"  bgcolor="#CCCCCC">
          <tr>
            <td >
				<%@ include file="../resume/userskill_form.jsp" %> 	
			</td>
          </tr>
 			<tr>
                <td><div align="center"><input type="button" value="保&nbsp;存" name="saveUserSkillBt" id="saveUserSkillBt" onClick="submitForm()"  style="  
